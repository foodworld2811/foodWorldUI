...
//   onTableSelect(event: Event): void {
//     // Save the selected table number in localStorage
//     if (this.selectedTableNumber) {
//       // localStorage.setItem('tableNumber', this.selectedTableNumber.toString());
//       this.isTableSelected = true; // Disable the select field after selection
//     }
//   }
